        ...
        {isSearchOpen && (
          <div className="fixed inset-0 z-[100] flex items-start justify-center pt-24 p-4">
            ...
            <motion.div 
              ...
              animate={{ opacity: 1, scale: 1, y: 0 }}
              exit={{ opacity: 0, scale: 0.95, y: -20 }}
              className="relative w-full max-w-lg bg-glass-10 backdrop-blur-2xl border border-glass-20 rounded-3xl p-6 shadow-2xl overflow-hidden animate-role-fade-in"
            >
